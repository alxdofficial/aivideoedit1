...
class Frame:
    def __init__(self, id, image, frame_number, video_path, description=None, chosen=False):
        self.id = id
...
#         frame = Frame(image=image, frame_number=frame_number, video_path=self.video_path)
